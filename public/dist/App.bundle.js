        ...
        _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
            ...
            if (res.data.length) {
                ...
                searchInput.on('keyup', function (e) {
                    ...
                    current = next;
                    var searchItems = search.querySelectorAll('.search__result');
                    ...
                    if (e.keyCode === 13) {
                        var aElement = searchItems[current].querySelector('a');
                ...
                searchResult.innerHTML = 'No result found for ' + _this.value;
            }
        }).catch(function (err) {
            console.log(err);
        });
...
var _autoMaps = __webpack_require__(10);

var _autoMaps2 = _interopRequireDefault(_autoMaps);

var _searchStore = __webpack_require__(13);
